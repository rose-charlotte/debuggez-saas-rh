                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half-row">
                    ...
                    <div class="flex-col">
                      ...
                      <input required type="number" min="0" class="form-control blue-border" data-testid="pct" placeholder="20" />
                    </div> 
                  </div>
                </div>
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <input required id="file" type="file" class="form-control blue-border" data-testid="file" accept=".png, .jpeg, .jpg" />
                  </div>
                </div>
            </div>
            <div class="row">
